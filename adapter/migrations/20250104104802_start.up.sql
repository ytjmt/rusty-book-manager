...
CREATE TABLE IF NOT EXISTS users (
  ...
  created_at TIMESTAMP(1024) WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  updated_at TIMESTAMP(1024) WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
UPDATE
  ON books FOR EACH ROW EXECUTE PROCEDURE set_updated_at();
